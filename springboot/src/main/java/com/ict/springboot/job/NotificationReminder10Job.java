...
@Component
@Slf4j
public class NotificationReminder10Job implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            ...
            log.info("10분 전 알림 Job 실행: simulationId={}", simulationId);
            ...
            // 10분 전 알림 발송
            notificationService.notifySimulationReminder10(
            ...
            log.info("10분 전 알림 발송 완료: simulationId={}", simulationId);
            
        } catch (Exception e) {
            log.error("10분 전 알림 Job 오류", e);
